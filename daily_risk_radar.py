...
def build_radar(credibility=None, intelligence=None, impacts=None, backlog=None, review=None, trend_attribution=None, deployment=None, deployment_history=None) -> dict:
