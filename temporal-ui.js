...
(function(){
  ...
  async function boot(){
    try{
      const data=await window.InsureAIData.loadSummary(), t=data.temporal||{}, topics=Array.isArray(t.topic_signals)?t.topic_signals.slice(0,6):[], entities=Array.isArray(t.entity_momentum)?t.entity_momentum.slice(0,6):[];
