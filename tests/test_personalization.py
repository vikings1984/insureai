...
class TestPersonalization(unittest.TestCase):
    ...
    def test_topic_and_entity_boost(self):
        result=P.personalize(self.events,{"role":"technology","topics":["ai_intelligent"],"entities":["nvidia"]})
    ...
    def test_role_boost_is_deterministic(self):
        result=P.personalize(self.events,{"role":"investment","topics":[],"entities":[]})
